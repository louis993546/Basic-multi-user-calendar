...
public class EmailService implements INotification {
	...
	public EmailService(String username, String address, String message) {
	...
	public void Send() {
		...
		String urlParameters = "username=" +  URLEncoder.encode(username) + "&address=" +  URLEncoder.encode(address) + "&message=" +  URLEncoder.encode(message) + "&subject=" +  URLEncoder.encode("[COMP3111 Calendar] Notification of the following events");
