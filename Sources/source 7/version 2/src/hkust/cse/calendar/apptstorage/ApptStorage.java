...
public abstract class ApptStorage {
	...
	public static HashMap<TimeSpan,Appt> mAppts; //a hashmap to save every thing to it, write to memory by the memory based storage implementation	
	...
	//added by me
	/*to manipulate the list of locations*/
	 ...
	 */
	public abstract int getGlobalID(); // to get the global ID for an appointment
